...
namespace NameThatQuote
{
    public partial class Form1 : Form
    {
        ...
        private void restart() {
            ...
            if (rndNumber == 0)
            {
                lblQuote.Text = "He's not gonna stop. You know that, right? A man like that. He's not even a man.";
                txtSpeaker[0] = "Molly";
            ...
            {
                lblQuote.Text = "I never wanted to be the type to think big thoughts about the nature of things. All I ever wanted was a stack of pancakes and a V8.";
                txtSpeaker[0] = "Bill";
            ...
            {
                lblQuote.Text = "Just one word. Yes, or no?";
                txtSpeaker[0] = "Malvo";
            ...
            {
                lblQuote.Text = "[I'm confused]... That's okay, I'm not.";
                txtSpeaker[0] = "Malvo";
                txtSpeaker[1] = "Lorne Malvo";
                picBox.Image = global::NameThatQuote.Properties.Resources.malvo;
            }
            ...
            {
                lblQuote.Text = "What's with all the duct tape?";
                txtSpeaker[0] = "Chumph";
            ...
            {
                lblQuote.Text = "No. Highly irregular is the time I found a human foot in a toaster oven. This is just odd.";
                txtSpeaker[0] = "Malvo";
                txtSpeaker[1] = "Lorne Malvo";
                picBox.Image = global::NameThatQuote.Properties.Resources.malvo;
            }
            ...
            {
                lblQuote.Text = "Because maps used to say, “There be dragons here.” Now they don’t. But that don’t mean the dragons aren’t there.";
                txtSpeaker[0] = "Malvo";
                txtSpeaker[1] = "Lorne Malvo";
                picBox.Image = global::NameThatQuote.Properties.Resources.malvo;
            }
            ...
            {
                lblQuote.Text = "Yah, but you gotta try, don't ya?";
                txtSpeaker[0] = "Gus";
            ...
            {
                lblQuote.Text = "Don't throw up in here. If you do, I will kill you. I will actually kill you.";
            ...
            {
                lblQuote.Text = "That's the thing, you're still wrong!";
                txtSpeaker[0] = "Molly";
